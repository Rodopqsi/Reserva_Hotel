...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DATABASE', 'examdb'),
...
# Optional MySQL SSL (e.g., PlanetScale) — enable by setting MYSQL_SSL=1
if os.getenv('MYSQL_SSL', '0') == '1':
    DATABASES['default'].setdefault('OPTIONS', {})['ssl'] = {'ssl': {}}
...
# DRF basic open API (no auth) for exam simplicity
REST_FRAMEWORK = {
